...
[![Semaphore Chat in action: a message is typed and sent in a team channel, teammates react and reply, a thread opens, and then a voice channel shows people talking.](https://raw.githubusercontent.com/semaphore-chat/semaphore-chat/media/video/hero.webp){ .no-lightbox loading=lazy }](tour.md)
