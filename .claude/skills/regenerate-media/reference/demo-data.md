...
docker compose run --rm --no-deps frontend pnpm exec eslint src/stories/fixtures/showcase.ts src/stories/fixtures/showcaseGifs.ts src/stories/tour/Tour.stories.tsx
```
